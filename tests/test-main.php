...
class MainTest extends WP_UnitTestCase {
	...
	protected $content_with_capital_tag = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. <IMG src="http://www.example.com/image.jpg" alt="test" /> Duis faucibus quis diam in molestie. Donec elementum risus sodales tristique malesuada, nisl eros accumsan odio';
	...
	function testFilterContent() {
		...
		$this->assertContains( 'data-echo', $this->plugin_class->filter_content( $this->content_with_capital_tag ) );
