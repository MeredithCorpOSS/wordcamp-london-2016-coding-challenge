 ...
 * Plugin URI:         https://www.github.com/TimeIncOSS/echo-js-lazy-load
 ...
 * GitHub Plugin URI:  https://www.github.com/TimeIncOSS/echo-js-lazy-load
 */
	...
	function change_img_markup( $matches ) {
		...
		$replace = array(
			'data-echo'               => array(
				...
				"src='" => sprintf( "scr='%s' data-echo='", $placeholder_image ),
			),
